...
INSERT INTO Producto(Prd_ID,Prd_Nombre,Prd_Precio)  
	 VALUES (1001,'VideoGrabador',35900),
			(1002,'Microondas',55780),
			(1003,'Televisor 21"',79990),
			(1004,'Centrifuga',48990),
			(1005,'Refrigerador',238780),
			(1006,'Lavadora',199990),
			(1007,'Radiograbador',34990),
			(1008,'Aspiradora',45740),
			(1009,'Televisor 14"',43840),
			(1010,'Televisor 29"',119990);
